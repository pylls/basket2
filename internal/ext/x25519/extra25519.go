...
import (
	...
	"github.com/pylls/basket2/internal/ext/x25519/edwards25519"
)
...
func PrivateKeyToCurve25519(curve25519Private *[32]byte, privateKey []byte) {
	h := sha512.New()
...
func PublicKeyToCurve25519(curve25519Public *[32]byte, publicKey []byte) bool {
	var pkCopy [32]byte
	if len(publicKey) != 32 {
		return false
	}
